...
class Genesis(AutotoolsPackage, CudaPackage):
    ...
    resource(
        when="@1.7.1",
        name="user_guide",
        url="https://www.r-ccs.riken.jp/labs/cbrt/wp-content/uploads/2021/12/GENESIS-1.7.1.pdf",
        sha256="abaa918935405a5876300011c7abb3bd157c2a3f9423e168f1fb58fdc130856c",
        expand=False,
        placement="doc",
    )
    resource(
